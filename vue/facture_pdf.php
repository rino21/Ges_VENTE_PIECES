...
$pdf->Cell(130,10,utf8_decode('FACTURE N°'.$idF),0,1,'C',True);
...
$pdf->Cell(15,7,'UTF',1,0,'C');
$pdf->Cell(15,7,'QTE',1,0,'C');
$pdf->Cell(25,7,'PRIX EN (AR)',1,0,'C');
$pdf->Cell(32,7,'MONTANT EN (AR)',1,1,'C');
$pdf->SetFont('Arial','',8);
...
while($prod = $vente->fetch()){
    ...
    $total = $total + $montant;
    $pdf->Cell(40,7,$prod["des"],1,0,'C');
    $pdf->Cell(15,7,$prod["UTE"],1,0,'C');
    $pdf->Cell(15,7,$prod["qte"],1,0,'C');
    $pdf->Cell(25,7,$prod["pu"],1,0,'C');
    $pdf->Cell(32,7,$montant,1,1,'C');
}
$tva = $total * 0.2;
$ttc = $tva+$total;
...
$pdf->Cell(32,7,$total,1,1,'C');

$pdf->Cell(40,7,'',0,0);
$pdf->Cell(55,7,'TVA 20%',1,0,'C');
$pdf->Cell(32,7,$tva,1,1,'C');

$pdf->Cell(40,7,'',0,0);
$pdf->Cell(55,7,'MONTANT TTC',1,0,'C');
$pdf->Cell(32,7,$ttc,1,1,'C');

$pdf->SetFont('Times','B',9);
$pdf -> Ln(5);
$lettre = new ChiffreEnLettre();
$res = strtoupper($lettre->Conversion($ttc));
$pdf->MultiCell(130,5,utf8_decode('Arrêtée la présente Facture à la somme de : '.$res.' ARIARY TTC.'),0,'C');
